<aside class="sidebar sidebar-default navs-rounded-all ">
    <div class="sidebar-header d-flex align-items-center justify-content-start">
        <a href="../dashboard/index.html" class="navbar-brand">
            ...
            <!--logo End-->
            <h4 class="logo-title">Fawatir</h4>
        </a>
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#horizontal-menu" role="button"
                        ...
                        <span class="item-name">Factures</span>
                        <i class="right-icon">
                    ...
                    <ul class="sub-nav collapse" id="horizontal-menu" data-bs-parent="#sidebar-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="{{ route('invoices.payees') }}">
                                <i class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                        fill="currentColor">
                                        <g>
                                ...
                                <span class="item-name">Payées</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="{{ route('invoices.nonPayees') }}">
                                ...
                                <i class="sidenav-mini-icon"> D </i>
                                <span class="item-name">Non payées</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="{{ route('invoices.partiellementPayees') }}">
                                <i class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                        fill="currentColor">
                                        <g>
                                ...
                                <span class="item-name">Partiellement payées </span>
                            </a>
                        </li>
